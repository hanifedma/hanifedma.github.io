...
\begin{frame}[plain]
  ...
  \begin{center}
    ...
    {\large\color{textsec} Research and engineering projects}\\[1.6em]
...
\begin{frame}{6-DOF Robot Manipulator Simulation (OpenGL)}
  \kicker{Engineering Projects}
  \chip{Robotics course project}\chip{Robot kinematics}\chip{C / OpenGL}\chip{Universitas Indonesia}\chip{May 2023}
  \bigskip
  \begin{itemize}\setlength\itemsep{8pt}
    \item Built as a project for a robotics course at Universitas Indonesia.
